            ...
            try {
                ...
                if (simplePastAnswer === 'yes') {
                    ...
                    if (negativeAnswer === 'yes') {
                        ...
                        prompt =
                            `What should Rose response for "${userAnswer}" based on "${currentQuestion.correctAnswer}"? Rose's response must be a question that the answer is ${currentQuestion.correctAnswer}.Rose answer must based on context ${questions}.response is not shown for rose`;
