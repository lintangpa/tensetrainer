        ...
        <div class=" p-1 rounded-lg shadow bg-white bg-opacity-15 backdrop-blur-lg">
            <div id="Header" class="mb-4">
                <div class="relative w-full bg-center mx-auto bg-cover bg-no-repeat rounded p-6 shadow-md text-center"
                    ...
                    <h2 class="text-2xl font-bold text-white shadow-black mb-4 z-10 relative">Simple Future 1</h2>
                </div>
            </div>
            <!-- Bagian cerita -->
            <div id="cerita">
        ...
        document.getElementById('checkBtn').addEventListener('click', async function() {
            try {
                ...
                if (simpleFutureAnswer === 'yes') {
                    ...
                    prompt =
                        `Jawab dengan maksimal 25 kata dimana letak kesalahan dari “${userAnswer}” dan apa yang perlu diubah agar menjadi simple future tense? Pembetulan harus berdasar pada "${currentQuestion.correctAnswer}"`;
