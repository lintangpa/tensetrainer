                            ...
                            <tbody class="bg-white divide-y divide-gray-200 text-left text-black">
                                @foreach ($achievement as $achievement)
                                    <tr>
                                        ...
                                        {{-- <td><button class="bg-amber-500 text-white p-1 rounded hover:bg-amber-600 focus:outline-none focus:bg-amber-600 mx-auto progressBtn"
                                                data-user-id="{{ $user->id }}">View Progress</button></td> --}}
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
