    ...
    <div class="h-full px-3 py-4 overflow-y-auto  bg-slate-900">
        <ul class="space-y-2 font-medium">
            ...
            <button type="button"
                ...
                <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Kelola</span>
            ...
            <li>
                <a href="{{ route('logout') }}"
                    class="flex items-center p-2 rounded-lg text-white  hover:bg-slate-700 group">
                    <svg class="flex-shrink-0 w-5 h-5transition duration-75  group-hover:text-white" aria-hidden="true"
