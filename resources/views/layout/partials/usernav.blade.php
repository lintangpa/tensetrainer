        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 rounded-lg text-white  hover:bg-violet-700 group">
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-violet-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            {{-- <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group text-white hover:bg-violet-700"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Tenses</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('simple-present') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Simple Present</a>
                    </li>
                    <li>
                        <a href="#"
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 rounded-lg text-white  hover:bg-violet-700 group">
                    <svg class="flex-shrink-0 w-5 h-5transition duration-75  group-hover:text-white"
